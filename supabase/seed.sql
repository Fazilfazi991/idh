...
values
('Private Residence', 'private-residence', 'Residential', 'Kerala', 'A contemporary residence balancing privacy, layered light and grounded materiality.', 'A contemporary residence balancing privacy, layered light and grounded materiality.', 'architecture_placeholders_webp/06-project-private-residence.webp', 'Residential', '2025', 'published', true, 10),
('Courtyard Home', 'courtyard-home', 'Interiors', 'Manjeri', 'A quiet interior composition designed around family gathering, calm finishes and softened edges.', 'A quiet interior composition designed around family gathering, calm finishes and softened edges.', 'architecture_placeholders_webp/02-hero-minimal-living-room.webp', 'Interiors', '2025', 'published', true, 20),
('Integrated Workspace', 'integrated-workspace', 'Commercial', 'Malappuram', 'A workspace shaped for clarity, collaboration and a restrained architectural identity.', 'A workspace shaped for clarity, collaboration and a restrained architectural identity.', 'architecture_placeholders_webp/07-project-commercial-office.webp', 'Commercial', '2024', 'published', true, 30),
('Boutique Hotel Lounge', 'boutique-hotel-lounge', 'Hospitality', 'Kerala', 'A moody guest experience with warm lighting, intimate scale and crafted material details.', 'A moody guest experience with warm lighting, intimate scale and crafted material details.', 'architecture_placeholders_webp/08-project-boutique-hotel-lounge.webp', 'Hospitality', '2024', 'published', true, 40),
('Hill View Villa', 'hill-view-villa', 'Residential', 'Wayanad', 'A refined family villa that frames landscape views through strong architectural lines.', 'A refined family villa that frames landscape views through strong architectural lines.', 'architecture_placeholders_webp/01-hero-modern-residence-exterior.webp', 'Residential', '2024', 'published', false, 50),
('Stair Gallery House', 'stair-gallery-house', 'Architecture', 'Calicut', 'A sculptural vertical journey designed as the visual heart of a private home.', 'A sculptural vertical journey designed as the visual heart of a private home.', 'architecture_placeholders_webp/03-hero-curved-staircase.webp', 'Architecture', '2023', 'published', false, 60)
