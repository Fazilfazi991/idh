  ...
  <main>
    ...
    <section class="about-editorial about-founders" aria-label="Studio leadership">
      <article class="founder-statement founder-primary reveal" data-about-person="founder">
        <figure><img data-about-image src="idh_transparent_cutouts_only/idh_transparent_cutouts/01_AR_Rashid_Founder_Principal_Architect.png" alt="AR Rashid, Founder and Principal Architect at Integrated Design Habitat" loading="lazy" /></figure>
      ...
      <article class="founder-statement founder-statement-reverse reveal" data-about-person="co_founder">
        <figure><img data-about-image src="idh_transparent_cutouts_only/idh_transparent_cutouts/02_Muhammed_Salih_TP_CoFounder_Design_Director.png" alt="Muhammed Salih TP, Co-Founder and Design Director at Integrated Design Habitat" loading="lazy" /></figure>
    ...
    <section class="about-editorial about-team" aria-labelledby="team-title">
      ...
      <div class="about-team-grid" data-about-team>
        <article class="reveal"><figure><img src="idh_transparent_cutouts_only/idh_transparent_cutouts/03_Midhun_K_Design_Head.png" alt="Midhun K, Design Head" loading="lazy" /></figure><h3>Midhun K</h3><p>Design Head</p></article>
        <article class="reveal"><figure><img src="idh_transparent_cutouts_only/idh_transparent_cutouts/04_Dilna_PC_Draughtswomen.png" alt="Dilna PC, Draughtswomen" loading="lazy" /></figure><h3>Dilna PC</h3><p>Draughtswomen</p></article>
        <article class="reveal"><figure><img src="idh_transparent_cutouts_only/idh_transparent_cutouts/05_Muhammad_Anas_K_MEP_Engineer.png" alt="Muhammad Anas K, MEP Engineer" loading="lazy" /></figure><h3>Muhammad Anas K</h3><p>MEP Engineer</p></article>
        <article class="reveal"><figure><img src="idh_transparent_cutouts_only/idh_transparent_cutouts/06_Muhammad_Althaf_Rahman_Site_Engineer.png" alt="Muhammed Althaf Rahman, Site Engineer" loading="lazy" /></figure><h3>Muhammed Althaf Rahman</h3><p>Site Engineer</p></article>
        <article class="reveal"><figure><img src="idh_transparent_cutouts_only/idh_transparent_cutouts/07_Shamseer_Kadavath_MEP_Head.png" alt="Shamseer Kadavath, MEP Head" loading="lazy" /></figure><h3>Shamseer Kadavath</h3><p>MEP Head</p></article>
      </div>
    </section>
